...
export function lighting(phase, roomId, meta, shared) {
  ...
  return {
    ...
    background: sky
      ...
      : { flat: hexToNum(INTERIOR_BACKGROUND) },
    ambient: fill
    ...
    // only greys it.
    fog: sky && look.fogTone ? { color: hexToNum(look.fogTone), near: 12, far: 260 } : null,
    ...
    grade: gradeFor(phase, roomId, meta, shared),
  };
}
...
export function gradeFor(phase, roomId, meta, shared) {
