...
// The goo is eaten straight from the kit, which must be in hand (GOO-F: "You're not holding the survival kit.").
const kitHeld = g => g.held('FOOD-KIT');
export const menus = { 'HIGH-PROTEIN': [{ verb: 'EAT', label: 'Drink' }], 'RED-GOO': [{ verb: 'EAT', when: kitHeld }], 'BROWN-GOO': [{ verb: 'EAT', when: kitHeld }], 'GREEN-GOO': [{ verb: 'EAT', when: kitHeld }] };
