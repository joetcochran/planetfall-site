...
- **In progress: the dispenser's hover** (item 39). Between the Machine Shop's buttons the hover label sticks on "gray button". It was being measured as this was written.
...
- **The loading spinner.** While a room takes more than a quarter of a second to load, the view shows the helmet from the favicon with a turning ring (12524b3c). It was the user's idea: "the 'planetfall guy' head".
...
- **Staying out of the pod's webbing.** The user first proposed killing a player who had not got into the webbing by a set turn. Canon already does, at the landing (globals.zil 1309-1324), and the user's own transcript had simply stopped before it. The user then settled it: "i am ok with the player riding out some of the escape pod trip outside of the webbing (since thats canon/ok)". Only the window changes (see above).
- **The shuttle signs follow canon's one switch.** When both cars sit at one platform, carding one West cabin lights both West signs. Canon has a single SHUTTLE-ON for both cars, and both sets of controls really are live then. The user: "leave the shuttle signs as they are" (3b180254).
