...
The user asked whether the design agent should do anything differently. Norm checked the packages against `world.json`, the rules and the ZIL, and found them "acceptable as they stand". Norm asked for six conventions:
...
| 5.1 | 12 Sep | The ledger cut down to the live queue, with the rest archived verbatim; the development agent named Norm |
