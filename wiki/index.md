...
| One room reconstructed from blockout through caps, states and playtest | 12–17 Sep | [Building Deck Nine](deck-nine-room-reconstruction.md) |
...
- [Playing it](playing-it.md): the text and click interfaces, the playtester agents and their rounds, the three play-to-end milestones, how far each tester got, and [what the testers logged, round by round](playing-it.md#what-the-testers-logged-round-by-round)
